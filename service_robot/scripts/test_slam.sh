...
gnome-terminal --tab -- bash -c "roslaunch service_robot gmapping_demo.launch"
sleep 3

echo "Starting Rviz"
gnome-terminal --tab -- bash -c "roslaunch service_robot view_slam.launch"
sleep 3

echo "Starting Teleop"
gnome-terminal --tab -- bash -c "roslaunch service_robot keyboard_teleop.launch"
